...
outage into a total one. Four hand-written copies of this layer disagreed about
it, which is a large part of why the package exists.
...
| `BIOHTTP_CACHE_DIR` | `data/cache` | Where the disk tier lives |
